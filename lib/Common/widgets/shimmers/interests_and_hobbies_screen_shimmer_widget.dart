...
class InterestsAndHobbiesScreenShimmerWidget extends StatelessWidget {
  const InterestsAndHobbiesScreenShimmerWidget({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: List.generate(12, (index) {
                      return _buildShimmerInterestChip();
                    }),
                  ),
                  heightSpace(40),
                ],
  ...
  Widget _buildShimmerInterestChip() {
