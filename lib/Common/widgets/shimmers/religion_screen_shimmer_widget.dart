...
class ReligionScreenShimmerWidget extends StatelessWidget {
  const ReligionScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(30),
                  // Religion chips shimmer
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    alignment: WrapAlignment.start,
                    children: List.generate(10, (index) {
                      return _buildShimmerReligionChip();
                    }),
                  ),
                  heightSpace(40),
                ],
  ...
  Widget _buildShimmerReligionChip() {
