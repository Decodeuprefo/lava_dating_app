...
class PreferredGenderScreenShimmerWidget extends StatelessWidget {
  const PreferredGenderScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(30),
                  // Gender options shimmer
                  Wrap(
                    spacing: 12,
                    runSpacing: 12,
                    children: [
                      _buildShimmerGenderOption(),
                      _buildShimmerGenderOption(),
                      _buildShimmerGenderOption(),
                    ],
                  ),
  ...
  Widget _buildShimmerGenderOption() {
