...
class SelectMaritalStatusScreenShimmerWidget extends StatelessWidget {
  const SelectMaritalStatusScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(30),
                  // Marital status options shimmer
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    children: [
                      _buildShimmerMaritalStatusOption(),
                      _buildShimmerMaritalStatusOption(),
                      _buildShimmerMaritalStatusOption(),
                      _buildShimmerMaritalStatusOption(),
                      _buildShimmerMaritalStatusOption(),
  ...
  Widget _buildShimmerMaritalStatusOption() {
