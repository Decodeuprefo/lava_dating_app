...
class RaceFlagsScreenShimmerWidget extends StatelessWidget {
  const RaceFlagsScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(50),
                  // Ethnicity chips shimmer
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    alignment: WrapAlignment.start,
                    children: List.generate(12, (index) {
                      return _buildShimmerEthnicityChip();
                    }),
                  ),
                  heightSpace(40),
                ],
  ...
  Widget _buildShimmerEthnicityChip() {
