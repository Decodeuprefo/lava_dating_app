...
class LifestyleScreenShimmerWidget extends StatelessWidget {
  const LifestyleScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(16),
                  // Drinking options shimmer
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    alignment: WrapAlignment.start,
                    children: List.generate(4, (index) {
                      return _buildShimmerLifestyleChip();
                    }),
                  ),
                  heightSpace(30),
                  // Do you smoke section shimmer
                  Row(
                    children: [
                      Container(
                        width: 27,
  ...
  Widget _buildShimmerLifestyleChip() {
