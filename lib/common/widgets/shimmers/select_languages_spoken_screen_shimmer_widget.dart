...
class SelectLanguagesSpokenScreenShimmerWidget extends StatelessWidget {
  const SelectLanguagesSpokenScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(55),
                  // Language chips shimmer
                  Wrap(
                    spacing: 10,
                    runSpacing: 10,
                    alignment: WrapAlignment.start,
                    children: List.generate(12, (index) {
                      return _buildShimmerLanguageChip();
                    }),
                  ),
                  heightSpace(40),
                ],
  ...
  Widget _buildShimmerLanguageChip() {
