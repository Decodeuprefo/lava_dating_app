...
class SelectEducationScreenShimmerWidget extends StatelessWidget {
  const SelectEducationScreenShimmerWidget({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  heightSpace(55),
                  // Education selector shimmer
                  _buildShimmerEducationSelector(),
                  heightSpace(40),
                ],
  ...
  Widget _buildShimmerEducationSelector() {
